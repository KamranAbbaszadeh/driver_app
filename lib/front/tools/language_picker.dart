import 'package:driver_app/front/tools/language_list.dart';
import 'package:flutter/material.dart';
import 'package:wolt_modal_sheet/wolt_modal_sheet.dart';

Future<void> showLanguangePicker(
    BuildContext context, Set<String> selectedLanguages) async {
              ...
              (context, index) {
                ...
                return StatefulBuilder(
                  builder: (context, setState) {
                    final isChecked = selectedLanguages.contains(languageName);
