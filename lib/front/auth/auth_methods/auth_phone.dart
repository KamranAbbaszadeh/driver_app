...
import 'package:driver_app/front/tools/remove_emojis.dart';
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            padding: EdgeInsets.only(
                              bottom: _countryCodeController.text.isNotEmpty
                                  ? 0
                                  : width * 0.025,
                              left: width * 0.025,
                              top: width * 0.038,
                                  ...
                                  Future.delayed(Duration(milliseconds: 200),
                                    ...
                                    showCountryPicker(
                                      ...
                                      countryListTheme: CountryListThemeData(
                                        ...
                                        padding:
                                            EdgeInsets.only(top: width * 0.045),
                          ...
                          if (isCountryEmpty)
                            Padding(
                              padding: EdgeInsets.only(
                                  left: width * 0.04, top: width * 0.007),
                              child: Text(
                                'Required',
                                style: TextStyle(
                                  fontSize: 12,
