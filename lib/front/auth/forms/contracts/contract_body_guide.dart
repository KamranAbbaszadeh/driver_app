...
class ContractBodyGuide extends StatelessWidget {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Bələdçi ilə Səyahət Agentliyi arasında Müqavilə',
              style: TextStyle(
                fontSize: width * 0.05,
            ...
            buildSubsection(
              ...
              '''
•	Bələdçini, ona həvalə edilən tur paketlərin, əvvəlcədən detalları ilə, aydın marşrutlarla və müştəri məlumatları ilə təmin etmək.
...
•	Ödənişləri razılaşdırılmış şərtlərə uyğun olaraq həyata keçirmək.
            ...
            buildSubsection(
              ...
              '''
•	Marşrut üzrə peşəkar bələdçi xidmətlərini göstərmək.
•	Turistlərin təhlükəsizliyini, məmnuniyyətini təmin etmək və dəqiq məlumat vermək.
...
•	Agentliyin nüfuzuna zərər gətirə biləcək hərəkətlərdən çəkinmək.
            ...
            buildSubsection(
              ...
              '''
2.1 Bələdçi vaxtında gəlməli, məlumatlı və [təqdim ediləcək dillər] üzrə səlis danışmalıdır.
2.2 Bələdçi razılaşdırılmış marşruta uyğun hərəkət etməli, vaxt rejiminə riayət etməli və turun lazımi müddət davam etməsini təmin etməlidir.
2.3 Turistlərə qarşı hər hansı narahatedici davranış, təcavüz və ya ayrı-seçkilik qəti qadağandır.
              ''',
              height,
              width,
              context,
            ...
            buildSubsection(
              ...
              '''
3.1	Bələdçi bu müqavilədə göstərilən xidmət standartlarına və öhdəliklərə riayət etmədikdə:
...
•	Agentlik müqaviləni dərhal ləğv etmək hüququnu özündə saxlayır.
            ...
            buildSubsection(
              ...
              '''
3.1	Bu müqavilə çərçivəsində [başlama tarixi] – dən, müqaviləyə xitan verilənə - dək razılaşdırılmış bələdçi xidmətlərinin tarifləri aşağıdakı kimidir:
            ''',
              height,
              width,
              context,
            ...
            buildSubsection(
              '3.2	Tariflər:',
              '''
•	Hava limanından qarşılama/ hava limanına yola salma üçün birdəfəlik 20 AZN
•	Bakı şəhəri daxilində göstərilən bələdçilik xidməti üçün gündəlik 70 AZN
•	Bakı şəhərinin xaricində şəhər daxili tarifə hər gecə sayına görə 20 AZN əlavə olunur
            ''',
              height,
              width,
              context,
            ...
            buildSubsection(
              '3.3	Tarif Şərtləri:',
              '''
•	Bələdçi yuxarıda göstərilən tariflər üzrə xidmətlər təqdim etməyi öhdəsinə götürür.
•	Tariflərin dəyişdirilməsi ilə bağlı hər hansı məlumat yazılı şəkildə bildirilməli və qarşı tərəf tərəfindən qəbul edilməlidir. Yazılı təsdiq olmadıqda, dəyişikliklər etibarlı sayılmayacaqdır.
            ''',
              height,
              width,
              context,
...
•	Agentlik, xidmət üçün tarix, saat, marşrut, qonaq sayı və hər hansı xüsusi tələblər daxil olmaqla, bron məlumatlarını ən az [X] saat/gün əvvəl Bələdçiyə təqdim etməlidir.
•	Bələdçi bronu aldıqdan sonra [X] saat ərzində təsdiqləməlidir.
...
•	Bələdçi təsdiqlənmiş bronu gözlənilməz hallara görə yerinə yetirə bilmədikdə, dərhal Agentliyi məlumatlandırmalı və əsaslı səbəb göstərməlidir.
            ''',
              height,
              width,
              context,
...
7.5	Müqavilənin ləğvi üçün bir tərəf digər tərəfə yazılı məlumat təqdim etməlidir. Yazılı bildiriş olmadıqda müqavilə qüvvədə qalacaqdır.
            ...
            buildSubsection(
              '8. Məxfilik',
              '''
8.1	Bələdçi, Agentlik və ya müştərilər barədə hər hansı məxfi məlumatı üçüncü tərəflərə açıqlamamalıdır.
8.2	Agentlik və ya onun tərəfdaşları ilə bağlı məxfi məlumatların paylaşılması halında, Agentlik Bələdçini məhkəməyə verə bilər.
              ''',
              height,
              width,
              context,
