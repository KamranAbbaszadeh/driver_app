// Firebase Cloud Functions for handling real-time notifications and user account management.
// Includes notification triggers on Firestore document changes, chat messages, tour assignments,
...
/// Handles approval and decline events for application and personal/car details forms, and registration completion.
...
/// Sends notifications to drivers when a new car tour is created matching their vehicle and profile criteria.
...
/// Sends notifications to guides when a new guide tour is created matching their languages and categories.
...
/// Notifies drivers when a previously assigned tour becomes available again due to driver removal.
...
/// Notifies guides when a previously assigned guide tour becomes available again due to guide removal.
...
/// HTTP endpoint securely deleting user accounts and cleaning up all associated user data from Firestore and Firebase Storage.
